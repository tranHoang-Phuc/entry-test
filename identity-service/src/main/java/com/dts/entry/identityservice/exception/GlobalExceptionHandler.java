...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorVm> handleAppException(AppException ex) {
        ...
        String errorCode = ex.getBusinessErrorCode() != null ? ex.getBusinessErrorCode() : Error.ErrorCode.UNCATEGORIZED_EXCEPTION;
        String message = ex.getMessage() != null ? ex.getMessage() : Error.ErrorCodeMessage.UNCATEGORIZED_EXCEPTION;
    ...
    public ResponseEntity<ErrorVm> handleAccessDeniedException(AccessDeniedException ex) {
        return buildErrorResponse(HttpStatus.FORBIDDEN, Error.ErrorCode.FORBIDDEN,
                Error.ErrorCodeMessage.FORBIDDEN, null, ex);
    }
    ...
    public ResponseEntity<ErrorVm> handleGeneralException(Exception ex) {
        ...
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR,
                Error.ErrorCode.UNCATEGORIZED_EXCEPTION,
                Error.ErrorCodeMessage.UNCATEGORIZED_EXCEPTION, null, ex);
    }
